...
This project is my attempt to write up a "Helm chart" for [zedeus/nitter](https://github.com/zedeus/nitter) using [Carvel](https://carvel.dev/) tools. The primary focus of this effort is to build on my current understanding of these tools by writing up something from scratch featuring a service I would actually like to use daily (a Twitter proxy).  So far, 
